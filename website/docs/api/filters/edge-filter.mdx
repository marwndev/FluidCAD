...
```ts
.onPlane(plane: PlaneLike, options?: { offset?: number; bothDirections?: boolean; partial?: boolean; }): this
```
...
| `options` | `{ offset?: number; bothDirections?: boolean; partial?: boolean; }` | Matching options: `offset` shifts the plane along its normal, `bothDirections` also matches the opposite offset, `partial` matches if at least one vertex lies on the plane. *(optional)* |

### .notOnPlane()

```ts
.notOnPlane(plane: PlaneLike, options?: { offset?: number; bothDirections?: boolean; partial?: boolean; }): this
```
...
|-----------|------|-------------|
| `plane` | [PlaneLike](/docs/api/types/plane-like) | The reference plane. |
| `options` | `{ offset?: number; bothDirections?: boolean; partial?: boolean; }` | Matching options: `offset` shifts the plane along its normal, `bothDirections` also excludes the opposite offset, `partial` excludes if at least one vertex lies on the plane. *(optional)* |
...
```ts
.above(plane: PlaneLike, options?: { offset?: number; partial?: boolean; }): this
```
...
|-----------|------|-------------|
| `plane` | [PlaneLike](/docs/api/types/plane-like) | The reference plane. |
| `options` | `{ offset?: number; partial?: boolean; }` | Matching options: `offset` shifts the plane along its normal, `partial` matches if at least one vertex is above the plane. *(optional)* |
...
```ts
.below(plane: PlaneLike, options?: { offset?: number; partial?: boolean; }): this
```
...
|-----------|------|-------------|
| `plane` | [PlaneLike](/docs/api/types/plane-like) | The reference plane. |
| `options` | `{ offset?: number; partial?: boolean; }` | Matching options: `offset` shifts the plane along its normal, `partial` matches if at least one vertex is below the plane. *(optional)* |
