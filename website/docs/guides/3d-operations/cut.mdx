...
See [Extrude — Extrude to face](/docs/guides/3d-operations/extrude#extrude-to-face) for detailed examples. The same rules apply: only **planar and cylindrical faces** are supported at the moment.
