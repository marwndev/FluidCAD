...
`copy()` called inside `sketch(...)` duplicates **sketch geometry** rather than solids, and circular copy takes a 2D center point instead of an axis. See the [2D Transforms guide](./sketching/transforms).
:::
