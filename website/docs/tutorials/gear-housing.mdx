...
In this tutorial, you'll build a gear housing based on exercises from [Too Tall Toby](https://www.tootalltoby.com/practice/). It covers filleting, angled chamfers, multi-level extrusions, draft cuts, arc profiles, complex sketches with rounded corners, drilling, counterbores, circular copy patterns, and mirror symmetry.
...
![Rib profile sketch](/img/docs/tutorials/gear-housing-step5-sketch.png)
...
![Side ribs mirrored](/img/docs/tutorials/gear-housing-step5.png)
