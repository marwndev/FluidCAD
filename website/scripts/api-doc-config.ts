...
export const features: FeatureEntry[] = [
  ...
  { name: 'arc', displayName: 'arc', category: '2d', sourceFile: 'core/2d/arc.ts', interfaceName: 'ArcFunction', returnType: 'IArcPoints | IArcAngles', sidebarPosition: 4 },
...
export const types: TypeEntry[] = [
  ...
  { name: 'ISlot', displayName: 'Slot', sourceFile: 'core/interfaces.ts', extendsType: 'IExtrudableGeometry', sidebarPosition: 15 },
  { name: 'IPolygon', displayName: 'Polygon', sourceFile: 'core/interfaces.ts', extendsType: 'IExtrudableGeometry', sidebarPosition: 16 },
  { name: 'IPlane', displayName: 'Plane', sourceFile: 'core/interfaces.ts', extendsType: 'ISceneObject', sidebarPosition: 17 },
  { name: 'IAxis', displayName: 'Axis', sourceFile: 'core/interfaces.ts', extendsType: 'ISceneObject', sidebarPosition: 18 },
  { name: 'ISelect', displayName: 'Select', sourceFile: 'core/interfaces.ts', extendsType: 'ISceneObject', sidebarPosition: 19 },
  { name: 'ITwoObjectsTangentLine', displayName: 'TwoObjectsTangentLine', sourceFile: 'core/interfaces.ts', extendsType: 'IGeometry', sidebarPosition: 20 },
  { name: 'ITangentArcTwoObjects', displayName: 'TangentArcTwoObjects', sourceFile: 'core/interfaces.ts', extendsType: 'IGeometry', sidebarPosition: 21 },
  { name: 'Point2DLike', displayName: 'Point2DLike', sourceFile: 'math/point.ts', sidebarPosition: 22 },
  { name: 'PointLike', displayName: 'PointLike', sourceFile: 'math/point.ts', sidebarPosition: 23 },
